...
Ry1 = N0*theta0*rectangularPulse((theta-0.5)/(2*theta0)) + ...
    N0*theta0*rectangularPulse((theta-1-0.5)/(2*theta0));
...
Ry2 = (N0*theta0/4)*(rectangularPulse((theta-0.5)/(2*theta0)) + ...
    rectangularPulse((theta-1-0.5)/(2*theta0))) + ...
    (N0*theta0/4)*(rectangularPulse((theta)/(2*theta0)) + ...
